...
local HeatingSetpointAround = 18.5 -- Temperature when nobody home, but still in neighbourhood
            ...
            elseif (device.level == ModeSelectorLevelAround) then
                ...
                if
                 ...
                 then
                    ...
                    if (OutsideTemp < HeatingSetpointAround) then
                        local NewSetpoint = HeatingSetpointAround
                        domoticz.log(
                            "Changing thermostat program to temporary and temp to " ..
                        ...
                        domoticz.log(
                            "Outside temp is higher then inside. No setpoint corrections performed.",
                            domoticz.LOG_DEBUG
                        )
                    end
                    --Als normaal de radio aan staat, deze uit zetten
